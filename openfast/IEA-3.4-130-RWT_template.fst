...
---------------------- INPUT FILES ---------------------------------------------
"%(EDFile)s" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"%(InflowFile)s" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"%(AeroFile)s"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
